<div id="content" role="main">
          ...
          <div class="box-wrap alignnone">
            <div class="box-round box-big flat-shadow">
              ...
              <span class="box-inner">
                <img class="" src="<?php echo base_url(''); ?>assets/images/design/custom-icons/custom-icon-imac.png" alt="a MAC" data-animation="">
              </span>
            </div>
          </div>
        </div>
        <div class="col-md-9 text-default">
          <h1 class="bordered-header">App design</h1>
          <p class="lead">Your bones don’t break, mine do. That’s clear. Your cells react to bacteria and viruses differently than mine. You don’t get sick, I do. That’s also clear. But for some reason, you and I react the exact same way to water. We swallow it too fast, we choke.</p>
        </div>
      </div>
    </div>
  </section>
  <section class="section swatch-white-red has-top">
    <div class="decor-top">
      <svg class="decor hidden-xs hidden-sm" height="100%" preserveaspectratio="none" version="1.1" viewbox="0 0 100 100" width="100%"
      ...
      <svg class="decor visible-xs visible-sm" height="100%" preserveaspectratio="none" version="1.1" viewbox="0 0 100 100" width="100%"
           xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="container">
      <header class="section-header">
        <h1 class="headline super hairline">More services</h1>
        <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam, minus, eius, eveniet ex repellat repellendus dolorum porro nesciunt mollitia possimus nihil ad corrupti illo rerum sapiente veniam laborum culpa dolores.</p>
      </header>
      <div class="row">
        <ul class="list-unstyled row box-list">
          <li class="col-md-3 text-center" data-os-animation="" data-os-animation-delay="">
            ...
            <h3 class="text-center">
              <a href="single-service.html">Mobile Ready</a>
            </h3>
          ...
          <li class="col-md-3 text-center" data-os-animation="" data-os-animation-delay="">
            ...
            <h3 class="text-center">
              <a href="single-service.html">HTML5 valid</a>
            </h3>
            <p class="text-center">Your bones don&#x27;t break, mine do. That&#x27;s clear. Your cells react to bacteria and viruses differently than mine.</p>
          </li>
          <li class="col-md-3 text-center" data-os-animation="" data-os-animation-delay="">
            ...
            <h3 class="text-center">
              <a href="single-service.html">CSS3 magic</a>
            </h3>
            <p class="text-center">Your bones don&#x27;t break, mine do. That&#x27;s clear. Your cells react to bacteria and viruses differently than mine.</p>
          </li>
          <li class="col-md-3 text-center" data-os-animation="" data-os-animation-delay="">
            ...
            <h3 class="text-center">
              <a href="single-service.html">Amazing design</a>
            </h3>
            <p class="text-center">Your bones don&#x27;t break, mine do. That&#x27;s clear. Your cells react to bacteria and viruses differently than mine.</p>
          </li>
        </ul>
